...
class WhiteboardApp:
    def __init__(self, root):
        ...
        self.pencil_icon = tk.PhotoImage(file=r"C:\Users\Binit Shaw\Desktop\Programing\Project\Digital White board\Logo\pencile1.png")
        self.eraser_icon = tk.PhotoImage(file=r"C:\Users\Binit Shaw\Desktop\Programing\Project\Digital White board\Logo\erasser.png")
        self.clear_icon  = tk.PhotoImage(file=r"C:\Users\Binit Shaw\Desktop\Programing\Project\Digital White board\Logo\clear_all.png")
        self.image_icon  = tk.PhotoImage(file=r"C:\Users\Binit Shaw\Desktop\Programing\Project\Digital White board\Logo\add_image.png")
        self.color_icon  = tk.PhotoImage(file=r"C:\Users\Binit Shaw\Desktop\Programing\Project\Digital White board\Logo\color.png")
        ...
        self.pencil_size_slider = tk.Scale(self.toolbar, from_=1, to=100, orient=tk.HORIZONTAL, label="Pencil Size")
    ...
    def scroll_canvas(self, event):
        ...
        if event.state == 0:  # No Shift key, vertical scroll
            self.canvas.yview_scroll(-1 * (event.delta // 120), "units")
        elif event.state == 1:  # Shift key pressed, horizontal scroll
